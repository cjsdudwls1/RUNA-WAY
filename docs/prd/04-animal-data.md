...
- 원칙: 실측과 추정을 구분해 표기한다
- 티어 순서는 이 표가 아니라 추격 시뮬 결과로 정한다. [08-m0-findings.md](08-m0-findings.md). 아래 30분 지속 속도는 도감 정보
...
사이클마다 스프린트 속도는 dv배, 지속은 dt배, 회복은 g배. M0에서 30분 평균이 4·5절 수치와 맞도록 보정.

| 유형 | 동물 | dv | dt | g | 근거 |
|---|---|---|---|---|---|
| 스프린터 | 치타, 그레이하운드, 집고양이, 유럽 산토끼 | 0.75 | 0.70 | 1.6 | 무산소 의존, 젖산 축적 빠름 |
| 중간 | 돼지, 하마, 다람쥐, 닭, 치와와, 코끼리 | 0.85 | 0.80 | 1.4 | 짧은 스프린트, 중간 회복 |
| 파충류·저대사 | 나일악어, 코모도왕도마뱀, 힐라몬스터, 아르마딜로, 코알라 | 0.60 | 0.60 | 2.0 | 무산소 대사 비중 큼, 회복 매우 김 |
| 지구력형 | 회색늑대, 진돗개 | 0.97 | 0.95 | 1.1 | 순항 지속 실측 |
| 트랙 B | 캥거루, 말, 썰매개, 낙타, 타조, 프롱혼 | 0.99 | 0.99 | 1.0 | 30분 이상 지속 실측 |
| 스프린트 없음 | 나무늘보, 늘보로리스 | - | - | - | 상태 머신 미적용, 등속 |
